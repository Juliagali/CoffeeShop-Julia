...
public class OrderController {
	...
	public ResponseEntity<Order> getById(@PathVariable Long orderId) {
		return orderRepository.findById(orderId).map(response -> ResponseEntity.ok(response))
	...
	public ResponseEntity<Order> deleteOrderItem(@PathVariable Long orderId, @PathVariable Long productId) {
